...
const JobView = () => {
  ...
  const projectInfo: ProjectInfo = {
    id: jobId || "1",
    name: "Residential Extension - Bondi",
    description: "Proposed two bedroom addition with modern kitchen and living area. This exciting project involves extending an existing family home to create a contemporary open-plan living space with seamless indoor-outdoor flow.",
    ...
    contact_email: "john@coastaldevelopments.com.au",
  ...
  const requirements = [
    "Detailed design plans for two-bedroom residential extension",
    "Modern kitchen and living area layout with focus on natural light",
    "Integration with existing home structure",
    "Council-compliant documentation for submission",
  ...
  const mockDocuments: Document[] = [
    {
      id: "1",
      name: "Existing_Property_Plans.pdf",
      file_url: "#",
                ...
                {projectInfo.status === 'open' ? (
                  <div className="space-y-2">
                    <Button 
                      className="w-full" 
                      size="lg"
                      onClick={() => navigate(`/submit-quote/${jobId}`)}
                    >
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    <p className="text-sm text-center text-muted-foreground">
                      This project is currently closed for new applications.
                    </p>
                  </div>
                )}
              </CardContent>
